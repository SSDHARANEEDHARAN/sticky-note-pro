...
export default function Auth() {
  ...
  const title = view === "login" ? "Welcome Back!" : view === "signup" ? "Join Sticky Notes" : "Reset Password";
  const buttonText = view === "login" ? "Sign In" : view === "signup" ? "Sign Up" : "Send Reset Link";
      ...
      <div className="w-full max-w-md">
        <div className="bg-note-yellow shadow-note p-8 relative">
          ...
          <div className="flex items-center gap-3 mb-6 justify-center">
            ...
            <h1 className="text-3xl font-handwriting font-bold text-card-foreground">{title}</h1>
          </div>

          {view === "forgot" && (
            <p className="text-sm text-card-foreground/60 text-center mb-4">
